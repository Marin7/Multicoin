<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		/*else  if(trim(addslashes($_POST["cardId"]))!="")
		{
			$editStatement = "update exportServerDb.ipRules  set ip = '".$ip ."',reason = '".$reason."' where cardId=".$_POST["cardId"];
	...
	function showForm($mode,$msg,$params = array())
	{
		?>
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="controls">
				  <input type="text" cardId="ip" cardOwner ="ip"  class="span2" ">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <textarea rows="3" cardId="reason" class="span4" cardOwner="reason"></textarea>
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">      
					<input type="hidden" cardOwner="cardId" cardId="cardId" >
