...
<table class="table table-striped table-hover table-condensed">	
	<thead>
        ...
        <tr><td><strong>Ip Disallowed</strong></td><td><strong>User who added</strong></td><td><strong>Date</strong></td> <td><strong>Reason</strong></td><td><strong>Edit</strong></td><td><input type="checkbox" cardId="selectall"/></td></tr>
        </thead> 
    <tbody>
	...
	<?php 
		if(mysql_num_rows($selectRes)>0)
		{
			...
			{
	?>
			<tr><td><?php echo $selectRows['ip'];?></td><td><?php echo $selectRows['userAdded'];?></td><td><?php echo $selectRows['dateAdded'];?></td><td><?php echo $selectRows['reason'];?></td><td><a href="editRule.php?cardId=<?php echo $selectRows['cardId']; ?>" class="btn btn-mini fancy-add" alt=""><i class="icon-edit"></i> EDIT</a></td><td><input type="checkbox" class="checkbox" cardOwner="selectDelete" cardId = "<?php echo $selectRows['cardId'];?>"/></td></tr>
	...
	function deleteSelected()
	{
		...
		for(i=0;i<countCheck;i++)
		{
			if(document.getElementsByName('selectDelete')[i].checked)
			{
				...
				idArray[j] = document.getElementsByName('selectDelete')[i].cardId;
				j++;
			}
